...
M557 X10:290 Y20:180 P8:5 			; Define mesh grid

; Stall Detection
M915 X Y S3 F0 H400 R2				; X / Y Axes (R before RRF 3.7 = R4700)
...
; Filament sensors
M591 D0 P1 C"e1stop" S1 ; Extruder 0 L7 R50:250 E3
M591 D1 P1 C"e0stop" S1 ; Extruder 1 L7 R50:250 E3
M591 D2 P1 C"xstop"  S1 ; Extruder 2 L7 R10:500 E3
M591 D3 P1 C"ystop"  S1 ; Extruder 3 L7 R50:250 E3
...
G10 P0 X19.92 Y44.16 Z-5.10 C0.00	;T0
G10 P1 X19.17 Y44.15 Z-5.57 C0.00	;T1
G10 P2 X-8.36 Y38.71 Z-13.17 C0.00	;T2
G10 P3 X13.59 Y50.97 Z-6.24 C0.00	;T3

; PID tune
M307 H0 R1.080 K0.245:0.000 D7.32 E1.35 S1.00 B0            ; PID tune bed
; M307 H0 R0.130 K0.150:0.000 D10.00 E1.35 S1.00 B1			; BANGBANG tune Bed
M307 H1 R3.094 K0.245:0.474 D7.06 E1.35 S1.00 B0 V24.2      ; PID tune T0 at 260 degrees
M307 H2 R2.873 K0.252:0.273 D8.58 E1.35 S1.00 B0 V24.2      ; PID tune T1 at 260 degrees
M307 H3 R1.892 K0.243:0.041 D5.61 E1.35 S1.00 B0 V24.2      ; PID tune T2 at 260 degrees
M307 H4 R3.656 K0.416:0.204 D5.78 E1.35 S1.00 B0 V24.2		; PID tune T3 at 260 degrees
...
; Skew correction
M556 S100 X-0.36 Y-0.03 Z-0.107
